...
onready var _item_holder = $SafeArea/VBoxContainer/MarginContainer/ScrollContainer/VBoxContainer
onready var _server_list = $SafeArea/VBoxContainer/MarginContainer/ScrollContainer
onready var _find_server = $SafeArea/VBoxContainer/MarginContainer/Control
onready var _error = $SafeArea/VBoxContainer/MarginContainer/error
